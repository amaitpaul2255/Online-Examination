...
public class Studentupdate extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if(src == back)
		{
			...
			new Admin1st().createpage2student();
		}
		else if(src == save)
		{
			try
	    	{
	    		...
	    		String s = "UPDATE studentreg SET Sid='"+logintext.getText()+"',Fname='"+fntext.getText()+"',Lname='"+lntext.getText()+"',"
						+ "Password='"+pass1text.getText()+"',RePassword='"+pass2text.getText()+"',Gender='"+gendertext.getText()+"',"
						+ "MailId='"+mailtext.getText()+"' WHERE Sid='"+updateid+"'";;
	    		rs = stm.execute(s);
